...
export type AppSettings={appearance:AppTheme;brandTheme:BrandTheme;language:Language;shopName:string;protectMinutes:number;notifications:boolean;compactCards:boolean};
export const DEFAULT_SETTINGS:AppSettings={appearance:'dark',brandTheme:'emerald',language:'en',shopName:'NEXT WALKING',protectMinutes:15,notifications:true,compactCards:false};
const KEY='next-walking-settings-v1';
